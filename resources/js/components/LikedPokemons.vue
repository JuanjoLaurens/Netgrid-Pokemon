<template>
  <div class="liked-pokemons">
    <h4 class="mb-5">Pokemones que te gustan</h4>
    <div class="container">
    <table class="table table-hover liked-table shadow-lg">
      ...
      <tbody>
        <tr class="text-center" v-for="(pokemon, index) in this.likedPokemons" :key="index">
          ...
          <td><button class="btn btn-primary" data-bs-toggle="modal" :data-bs-target="`#listdetailsModal-${pokemon.pokemon_id}`">Más detalles</button></td>
