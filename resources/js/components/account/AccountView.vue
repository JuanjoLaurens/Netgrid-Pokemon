<template>
  <div class="account-view">
    <div class="container">
      <h4>Bienvenido, {{this.loggedInEmail}}!</h4>
      <p class="text-primary">Haz doble click para editar tus datos</p>
      <div class="row shadow-lg">
        <div class="col rounded-start form-side">
          <h5 class="heading text-white">Datos del usuario</h5>
            ...
            <div class="mb-3">
              <label class="form-label text-white">Fecha Nacimiento</label>
              <input
                type="date"
                id="bdate"
                :disabled="this.editable==false"
